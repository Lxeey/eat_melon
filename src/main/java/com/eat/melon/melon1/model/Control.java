...
public class Control {
    ...
    public void setInput_disable(boolean input_disable) {
     ...
     public boolean getInput_disable() {
    ...
    public void setEmpty_page(String empty_page) {
         this.empty_page = empty_page;
     }
     public String getEmpty_page() {
         return empty_page;
     }
    ...
    public void setWeb_selection(boolean web_selection) {
     ...
     public boolean getWeb_selection() {
    ...
    public void setDisable_jump_emote(boolean disable_jump_emote) {
     ...
     public boolean getDisable_jump_emote() {
         return disable_jump_emote;
     }

    public void setEnable_charged(boolean enable_charged) {
         this.enable_charged = enable_charged;
     }
     public boolean getEnable_charged() {
         return enable_charged;
     }

    public void setEnable_cm_biz_helper(boolean enable_cm_biz_helper) {
         this.enable_cm_biz_helper = enable_cm_biz_helper;
     }
     public boolean getEnable_cm_biz_helper() {
         return enable_cm_biz_helper;
     }
